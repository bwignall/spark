...
class ShuffleReadMetrics private[spark] () extends Serializable {
  ...
  private[spark] def setRemoteBlocksFetched(v: Int): Unit =
    _remoteBlocksFetched.setValue(v)
  private[spark] def setLocalBlocksFetched(v: Int): Unit =
    _localBlocksFetched.setValue(v)
  private[spark] def setRemoteBytesRead(v: Long): Unit =
    _remoteBytesRead.setValue(v)
  private[spark] def setRemoteBytesReadToDisk(v: Long): Unit =
    _remoteBytesReadToDisk.setValue(v)
  private[spark] def setLocalBytesRead(v: Long): Unit =
    _localBytesRead.setValue(v)
  ...
  private[spark] def setRemoteReqsDuration(v: Long): Unit =
    _remoteReqsDuration.setValue(v)
  ...
  private[spark] def setMergeValues(
      metrics: Seq[TempShuffleReadMetrics]
  ): Unit = {
