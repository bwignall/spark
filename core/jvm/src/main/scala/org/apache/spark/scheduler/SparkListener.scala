...
@DeveloperApi
case class SparkListenerBlockManagerRemoved(
    time: Long,
    blockManagerId: BlockManagerId
) extends SparkListenerEvent
...
@DeveloperApi
case class SparkListenerExecutorAdded(
    time: Long,
    executorId: String,
...
private[spark] trait SparkListenerInterface {
  ...
  /** Called with the peak memory metrics for a given (executor, stage) combination. Note that this
    ...
    */
  def onStageExecutorMetrics(
      executorMetrics: SparkListenerStageExecutorMetrics
  ): Unit
  ...
  def onExecutorExcludedForStage(
      executorExcludedForStage: SparkListenerExecutorExcludedForStage
  ): Unit
  ...
  def onExecutorUnexcluded(
      executorUnexcluded: SparkListenerExecutorUnexcluded
  ): Unit
...
abstract class SparkListener extends SparkListenerInterface {
  ...
  override def onExecutorExcluded(
      executorExcluded: SparkListenerExecutorExcluded
  ): Unit = {}
  ...
  override def onNodeExcluded(
      nodeExcluded: SparkListenerNodeExcluded
  ): Unit = {}
  ...
  override def onNodeUnexcluded(
      nodeUnexcluded: SparkListenerNodeUnexcluded
  ): Unit = {}
